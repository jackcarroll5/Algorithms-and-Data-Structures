...
public class TestMyArrays {
    public static void main(String[] args) {
        ...
        int[] n = {12, 15, 18, 21, 24, 30, 38, 45, 67, 71};
      ...
      String[] mergeString = MyArrays.merge(nameList1,0,3,nameList2,0,4);//Expected = Ann,Bill,Bob,Joe,Rob,Sam,Sue,Tim,Tom
        ...
        System.out.println(Arrays.toString(numList1));//Shortcut
        ...
        int binSearch6 = MyArrays.binarySearchAlt(numList2,2341);//Expected = -1(Element)
        System.out.println("\nThe element found here in the alt binary search was " + binSearch6);
        ...
        //output newSize //expected value?
        //output list2 //expected contents
        System.out.println("\n\nAlt remaining length in array list2 is " + newerSize);
       ...
       int newSize1 = MyArrays.insertArrayItem(list2, newSize, 23,3);//Expected length = 5
        ...
        int nSize = MyArrays.removeArrayItemAlt(list1, 2, list1.length);//Expected length = 4
        //output newSize //expected value?
        //output list2 //expected contents
        System.out.println("\n\nRemaining length in array is " + nSize);

        int ns = MyArrays.insertArrayItem(list1, list1.length, 24,2);//Expected length = 5
        //output newSize //expected value?
        //output list2 //expected contents
        System.out.println("\n\nThe new length of the array list2 is " + ns);


        int max0 = MyArrays.max(list1,list1.length);
        System.out.println("\n\nMax number for list 1 is " + max0);//Expect max = 9

        int maximum = MyArrays.numberLessThanMax(list1,list1.length);
        System.out.println("\nIndex number for list 1 is " + maximum);//Expect max = 4

        int max1 = MyArrays.max(list2,sizeList2);
        System.out.println("\nMax number for list 2 is " + max1);//Expect max = 12

        int ma = MyArrays.numberLessThanMax(numList1,numList1.length);
        System.out.println("\n\nIndex number for list 1 is " + ma);//Expect max = 16

        int m = MyArrays.numberLessThanMax(l6,l6.length);
        System.out.println("\nIndex number for list 1 is " + m);//Expect max = 16

        int maxi = MyArrays.numberLessThanMax(numList2,numList2.length);
        System.out.println("\nIndex number for list 1 is " + maxi);//Expect max = 16

        int max = MyArrays.numberLessThanMax(list3,list3.length);
        System.out.println("\nIndex number for list 1 is " + max);//Expect max = 16
